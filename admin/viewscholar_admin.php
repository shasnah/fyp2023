...
<div class="head_view">
		...
		<a href="insertscholar_admin.php" class="btn btn-primary">Add New</a>
...
if ($num > 0) { 
        ...
        <table class="table table-striped table-hover" style="width: 75%; margin: 0 auto;">
            <thead class="table-head-dark">
                <tr>
                    ...
                    <th scope="col">Scholarship Pagelink</th>
    ...
    while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
        ...
        echo '<tr>
            ...
            <td>' . $row['scholar_title'] . '</td>
            <td>' . $row['scholar_descript'] . '</td>
            <td>' . $row['scholar_deadline'] . '</td>
            <td>' . $row['scholar_link'] . '</td>
            <td><a href="editscholar_admin.php?scholar_id=' . $scholar_id . '"><button type="button" class="btn btn-success">Edit</button></a></td>
            <td><a href="deletescholar_admin.php?scholar_id=' . $scholar_id . '"><button type="button" class="btn btn-danger">Delete</button></a></td>
        </tr>';
    }
